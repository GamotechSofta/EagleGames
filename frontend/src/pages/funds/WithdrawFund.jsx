    ...
    return (
        <div className="space-y-6">
            ...
            <div className="rounded-2xl bg-[#111827] p-0">
                <div className="bg-[#111827] rounded-2xl shadow-md border border-[#374151] overflow-hidden">
                    ...
                    <div className="bg-gradient-to-r bg-[#1a74e5] px-4 py-3 flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-[#111827]/20 border border-white/30 flex items-center justify-center shrink-0">
                            <div className="w-8 h-8 rounded-full bg-[#111827] flex items-center justify-center text-sm font-extrabold text-[#1a74e5]">
                                ₹
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div className="space-y-2">
                        {bankAccounts.map((acc) => (
                            <label
                                key={acc._id}
                                className={`flex items-center p-4 bg-[#111827] border rounded-xl cursor-pointer transition-colors ${
                                    selectedBankId === acc._id
                                        ? 'border-[#1a74e5] bg-[#1f2937]'
                            ...
                            >
                                ...
                                <div className={`w-5 h-5 rounded-full border-2 ml-3 flex items-center justify-center ${
                                    selectedBankId === acc._id ? 'border-[#1a74e5]' : 'border-[#374151]'
                                }`}>
                                    {selectedBankId === acc._id && (
                                        <div className="w-3 h-3 bg-[#1a74e5] rounded-full"></div>
                                    )}
                                </div>
                            </label>
                        ))}
