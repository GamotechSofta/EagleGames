        ...
        <div className={`space-y-4 sm:space-y-6 ${step === 2 ? 'pb-28' : ''}`}>
            ...
            {step === 1 ? (
                ...
                <div className="space-y-6">
                    {/* Amount summary + edit */}
                    <div className="flex items-center justify-between gap-3 bg-[#1f2937] rounded-2xl p-4 border-2 border-[#374151]">
                        <div className="min-w-0">
                            <div className="text-gray-300 text-sm">Selected Amount</div>
                            <div className="text-[#1a74e5] font-extrabold text-lg truncate">₹{Number(amount || 0).toLocaleString('en-IN')}</div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between bg-[#1f2937] rounded-xl p-4 border-2 border-[#374151]">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-gradient-to-r bg-[#1a74e5]  hover:bg-[#155fc2] text-white rounded-lg text-sm font-extrabold shadow-md"
                                >
                                    Copy
                                </button>
                            </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                inputMode="numeric"
                                className="w-full bg-[#111827] border-2 border-[#374151] rounded-xl px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#1B3150] focus:border-[#1a74e5]"
                                required
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <label
                                    ...
                                    className="flex flex-col items-center justify-center w-full h-40 bg-[#1f2937] border-2 border-dashed border-[#374151] rounded-xl cursor-pointer hover:border-[#4b5563] transition-colors"
                                >
                                    {screenshotPreview ? (
                                        <img
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-4 bg-gradient-to-r bg-[#1a74e5]  hover:bg-[#155fc2] text-white font-extrabold rounded-xl transition-all disabled:opacity-50 shadow-md"
                        >
