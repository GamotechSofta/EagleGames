...
const HalfSangamBBid = ({ market, title }) => {
    ...
    const submitBtnClass = (enabled) =>
        enabled
            ...
            : 'w-full bg-gradient-to-r bg-gray-400 text-white font-bold py-3.5 min-h-[48px] rounded-lg shadow-md opacity-50 cursor-not-allowed';
    ...
    const handleAdd = () => {
        ...
        if (!/^[0-9]$/.test(enteredOpenAnk)) {
            showWarning(bid.pleaseEnterOpenAnk);
            return;
        }
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex flex-row items-center gap-2">
                                <label className="text-gray-200 text-sm font-medium shrink-0 w-40">Enter Open Ank:</label>
                                <input
                                    type="text"
                                    inputMode="numeric"
                                    value={openAnk}
                                    ...
                                    placeholder="Ank"
                                    className="flex-1 min-w-0 bg-[#111827] border-2 border-[#374151] text-white placeholder-gray-400 rounded-full py-2.5 min-h-[40px] px-4 text-center text-sm focus:ring-2 focus:ring-[#1B3150] focus:border-[#1a74e5] focus:outline-none"
                                />
                            </div>

                            <div className="flex flex-row items-center gap-2">
                                <label className="text-gray-200 text-sm font-medium shrink-0 w-40">Enter Close Pana:</label>
                                <input
                                    type="text"
                                    inputMode="numeric"
                                    value={closePana}
