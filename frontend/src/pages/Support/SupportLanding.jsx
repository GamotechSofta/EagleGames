...
const SupportLanding = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1f2937] text-white px-3 sm:px-6 md:px-8 pb-[calc(6rem+env(safe-area-inset-bottom,0px))]">
      <div className="w-full max-w-xl mx-auto">
        <div className="flex items-center gap-3 pt-4 pb-3">
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="p-1.5 min-w-[36px] min-h-[36px] flex items-center justify-center text-white hover:text-[#1a74e5] active:scale-95 transition touch-manipulation"
            aria-label="Back"
          >
          ...
          <h1 className="text-xl sm:text-2xl font-semibold text-[#1a74e5]">Help Desk</h1>
        </div>
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full bg-[#111827] rounded-2xl border-2 border-[#374151] p-5 shadow-sm text-left flex items-center gap-4 hover:border-[#1a74e5] hover:shadow-md transition"
          >
            <div className="w-12 h-12 rounded-xl bg-[#1f2937] flex items-center justify-center shrink-0">
            ...
            <svg className="w-5 h-5 text-[#1a74e5] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
