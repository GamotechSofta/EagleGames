            ...
            <div className="min-w-0 max-w-full" style={{ backgroundColor: 'rgb(248, 249, 250)' }}>
                <div className="mb-6">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 flex items-center gap-3">
                        <span className="w-10 h-10 rounded-xl bg-[#1B3150]/20 flex items-center justify-center">
                            <svg className="w-5 h-5 text-[#1B3150]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-16">
                        <div className="animate-spin rounded-full h-10 w-10 border-2 border-gray-200 border-t-[#1B3150]" />
