...
const Button = ({
    ...
    const variants = {
        primary: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white glow-blue hover:-translate-y-0.5",
        ...
        outline: "bg-transparent hover:bg-blue-50 text-blue-600 border border-blue-300 hover:border-blue-500",
    };
