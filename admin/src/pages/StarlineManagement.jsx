                ...
                {!activeTab ? (
                    <>
                        <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
                            <h1 className="text-xl sm:text-2xl font-bold text-blue-500">Starline</h1>
                            {!loadingGroups && starlineGroups.length > 0 && (
                                <button
                                    type="button"
                                    onClick={() => { setShowAddMarket(true); setNewMarketLabel(''); setAddMarketError(''); }}
                                    className="px-4 py-2.5 rounded-xl font-semibold text-sm bg-emerald-600 hover:bg-blue-500 text-gray-800 shadow-lg shadow-emerald-900/30"
                                >
                                    + Add market
                                </button>
                            )}
                        ...
                        {loadingGroups ? (
                            ...
                            <div className="rounded-2xl border-2 border-dashed border-blue-200 bg-white p-10 text-center">
                                ...
                                <button
                                    type="button"
                                    onClick={() => { setShowAddMarket(true); setNewMarketLabel(''); setAddMarketError(''); }}
                                    className="px-5 py-3 rounded-xl bg-blue-500 hover:bg-blue-600 text-gray-800 font-semibold text-sm"
                                >
                                    + Add Starline market
                                </button>
                            </div>
                                            ...
                                            >
                                                ...
                                                <div className="p-5 flex flex-col flex-1 min-h-0">
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-full mt-auto px-4 py-3 rounded-xl bg-blue-500 hover:bg-blue-600 text-gray-800 font-semibold text-sm flex items-center justify-center gap-2 shadow-md shadow-blue-900/20"
                                                    >
                                                        Manage slots & result
                    ...
                    <>
                        ...
                        <nav className="flex items-center gap-2 text-sm text-gray-400 mb-3">
                            <button type="button" onClick={() => { setActiveTab(''); setSelectedResultMarket(null); }} className="hover:text-blue-500 transition-colors">Starline</button>
                            <span>/</span>
                    ...
                    <div className="flex flex-col xl:flex-row xl:gap-6">
                                ...
                                <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                                    <div>
                                        <h2 className="text-base font-bold text-gray-800 flex items-center gap-2">
                                            <span className="flex items-center justify-center w-7 h-7 rounded-lg bg-blue-500/20 text-blue-500 font-mono text-sm">1</span>
                                            Time slots
                                        </h2>
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2.5 rounded-xl bg-blue-500 hover:bg-blue-600 text-gray-800 font-semibold text-sm"
                                    >
                                        + Add slot
                                    </button>
                                </div>
                                {slotsForTab.length === 0 ? (
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                        {slotsForTab.map((m) => {
                                            ...
                                            return (
                                                <div key={m._id} className="bg-white rounded-xl border border-gray-200 p-4 hover:border-blue-200 transition-colors">
                                                    ...
                                                    <div className="flex flex-wrap gap-2">
                                                        ...
                                                        <button type="button" onClick={() => handleEdit(m)} className="px-3 py-1.5 rounded-lg bg-blue-600/80 hover:bg-blue-600 text-gray-800 text-xs font-medium">Edit time</button>
                        ...
                        {showAddSlot && (
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
                                <div className="bg-white rounded-2xl border border-blue-200 shadow-xl max-w-md w-full p-6">
                                    ...
                                    <form onSubmit={handleAddSlotSubmit} className="space-y-4">
                                        ...
                                        <div className="flex gap-3 pt-1">
                                            <button type="submit" disabled={addLoading} className="flex-1 py-2.5 rounded-xl bg-blue-500 hover:bg-blue-600 text-gray-800 font-semibold text-sm disabled:opacity-50">
                            ...
                            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
                                <div className="bg-white rounded-2xl border border-blue-200 shadow-xl max-w-md w-full p-6">
                                    ...
                                    <form onSubmit={handlePasswordSubmit} className="space-y-4">
                                        ...
                                        <div className="flex gap-3">
                                            <button type="submit" disabled={declareLoading} className="flex-1 py-2.5 rounded-xl bg-blue-500 hover:bg-blue-600 text-gray-800 font-semibold text-sm disabled:opacity-50">Declare</button>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 p-4">
                        <div className="bg-white rounded-2xl border border-blue-200 shadow-xl max-w-md w-full p-6">
                            ...
                            <form onSubmit={handleAddMarketSubmit} className="space-y-4">
                                ...
                                <div className="flex gap-3 pt-1">
                                    <button type="submit" disabled={addMarketLoading} className="flex-1 py-2.5 rounded-xl bg-blue-500 hover:bg-blue-600 text-gray-800 font-semibold text-sm disabled:opacity-50">
