        ...
        <AdminLayout onLogout={handleLogout} title="Settings">
            <div className="w-full min-w-0 px-3 sm:px-4 md:px-6 pb-6 sm:pb-8">
                ...
                <div className="rounded-xl border border-gray-200 bg-white shadow-lg overflow-hidden max-w-xl">
                    <h2 className="text-lg font-bold text-blue-500 bg-white px-4 py-3 border-b border-gray-200">
                    ...
                    <div className="p-4 space-y-3">
                        ...
                        <form onSubmit={handleSetSecret} className="space-y-4">
                                    ...
                                    {!forgotSecret ? (
                                        <>
                                            ...
                                            <input
                                                ...
                                                placeholder=""
                                                className="w-full px-4 py-2.5 rounded-lg bg-gray-100 border border-gray-200 text-gray-800 placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="px-6 py-2.5 bg-blue-500 hover:bg-blue-600 text-gray-800 font-semibold rounded-lg disabled:opacity-50 transition-colors"
                            >
