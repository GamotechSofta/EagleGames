        ...
        <AdminLayout onLogout={handleLogout} title="Result Declared">
            <div className="w-full min-w-0 max-w-lg mx-auto px-4 sm:px-6 py-8 sm:py-12">
                <div className="rounded-xl border-2 border-green-200 bg-green-500/10 p-6 sm:p-8 text-center">
                    ...
                    {displayText && (
                        <p className="text-blue-500 font-mono text-sm sm:text-base">{displayText}</p>
                    )}
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <button
                        ...
                        className="px-5 py-3 bg-blue-500 hover:bg-blue-600 text-gray-800 font-semibold rounded-xl transition-colors"
                    >
                        Add another result
                    </button>
                    <button
